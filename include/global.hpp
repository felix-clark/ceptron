...
template <int M =
              Eigen::Dynamic>  // don't think we need anything but column arrays
using Array = Eigen::Array<scalar, M, 1>;
using ArrayX = Array<Eigen::Dynamic>;
template <int M = Eigen::Dynamic>  // we might use this type explicitly for
                                   // element-wise computations
                                   using BatchArray =
                                       Eigen::Array<scalar, M, Eigen::Dynamic>;
